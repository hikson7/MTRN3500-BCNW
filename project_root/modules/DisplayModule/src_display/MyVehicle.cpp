...
void drawUGV(double steerAngle)
{
	...
	const float vertices[10][3] = {
		// left-hand side
		{ .5,   static_cast<float>(wheel_height -0.1),    width},
		{-.5,   static_cast<float>(wheel_height -0.1),    width},
		{-.5,   static_cast<float>(wheel_height +0.3),    width},
		{ .4,   static_cast<float>(wheel_height +0.3),    width},
		{ .5,   static_cast<float>(wheel_height +0.15),   width},
		// right-hand side
		{ .5,   static_cast<float>(wheel_height -0.1),   -width},
		{-.5,   static_cast<float>(wheel_height -0.1),   -width},
		{-.5,   static_cast<float>(wheel_height +0.3),   -width},
