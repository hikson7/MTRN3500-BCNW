...
int main(int argc, char *argv[]) {
	/* An arbitrarily named file, ".shm_key" is created to ensure that such file exists. This file is used as an argument to create unique key for the shared memory. Use the same path to this file for every process that require access to the same shared memory!"*/
